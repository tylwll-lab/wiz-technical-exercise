...
# used to SSH in and also to update the private IP in deployment.yaml for the mongoDB environment variable.
...
# VPC ID - useful for networking issues and verifying resources are in the right VPC
# Pulls from the VPC.tf
output "vpc_id" {
  value = module.vpc.vpc_id
}

# ECR repository URL - used when tagging and pushing docker images
